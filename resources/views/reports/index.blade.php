                                    ...
                                    <tbody>
                                        @foreach ($reports as $report)
                                            <tr>
                                                <td>
                                                    <span class="badge
                                                        @if($report->report_type == 'Financial') badge-success
                                                        @elseif($report->report_type == 'Project Summary') badge-info
                                                ...
                                                <td>
                                                    <button class="btn btn-info btn-sm">
                                                         <a href="{{ route('reports.edit', $report->id) }}"class="text-white">View</a>
                                                    </button>
