                    ...
                    <div class="col-md-12">
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                                ...
                                <button class="btn btn-light btn-sm"><i class="fas fa-edit"></i> Edit</button>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <p><strong><i class="fas fa-building me-2"></i> Company:</strong> {{ $client->company_name ?? 'N/A' }}</p>
                                        <p><strong><i class="fas fa-map-marker-alt me-2"></i> Address:</strong> {{ $client->address ?? 'N/A' }}</p>
                                        <p><strong><i class="fas fa-calendar-alt me-2"></i> Added On:</strong> {{ $client->created_at->format('d M Y') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        @foreach ($client->projects as $project)
                            @foreach ($project->invoices as $invoice)
                                <tr>
                                    ...
                                    <td>{{ $project->name }}</td> <!-- عرض اسم المشروع -->
...
<div class="col-md-12 mt-4">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-light btn-sm"><i class="fas fa-plus"></i> Add Note</button>
        </div>
        <div class="card-body">
            @forelse ($client->notes as $note)
                <div class="border p-3 rounded bg-light mb-2">
                    <p><strong>{{ $note->employee->name }}</strong> ({{ $note->created_at->format('d M Y H:i') }})</p>
                    <p>{{ $note->note }}</p>
                </div>
            @empty
